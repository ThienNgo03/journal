import { ChevronDown, InfoIcon, LockIcon, LogOutIcon, Table2 } from "lucide-react"
...
import { useGetSidebar } from "./_apis/get-side-bar";
...
export function AppNavigation() {
    ...
    const { data: sidebarData, isLoading } = useGetSidebar()
